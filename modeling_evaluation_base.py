...
class BGE_AudioToken(nn.Module):
    ...
    def t_encoder(self, texts):
        ...
        num_layers = self.bge_encoder.config.num_hidden_layers
    ...
    def a_encoder(self, audios, prompts = None):
        ...
        # embeddings = embeddings.reshape(B,S,T,C)
        # print(f"embeddings222222222shape: {embeddings.shape}")
        # embeddings = embeddings.mean(dim=1)
        # print(f"embeddings333333333shape: {embeddings.shape}")
    ...
    # def save_pretrained(self, output_dir: str, pretrained_config_dir: str = "/home/ls/pretrained_config/"):
    ...
    # def save(self, output_dir: str, pretrained_config_dir: str = "/home/ls/pretrained_config/"):
    #     os.makedirs(output_dir, exist_ok=True)
